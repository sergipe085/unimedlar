...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="bg-[#F6F5F8] min-h-[200vh] pt-10 flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px]  transform md:scale-100  scale-[1] sm:scale-50"
    >
      <motion.h2
        style={{
...
export const Lid = ({
  ...
  return (
    <div className="relative">
      <Image src={"/iphone.png"} alt={"asdad"} width={512} height={512} className="w-[500px] relative pr-20"></Image>
      <motion.div
        style={{
          scaleX: scaleX,
          scaleY: scaleY,
        ...
        className="h-[475px] mt-1 ml-36 absolute inset-0  p-2"
      >
        
        <div className="absolute inset-0  bg-screen aspect-16/9" />
...
export const KBtn = ({
  ...
  return (
    <div
      className={cn(
        "p-[0.5px] rounded-[4px]",
        backlit && "bg-white/[0.2] shadow-xl"
      )}
    >
      <div
        className={cn(
